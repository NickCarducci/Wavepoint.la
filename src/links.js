...
import NewForum from "./components/Forum/New/NewForum";
...
class Links extends React.Component {
  ...
  browseCommunities = (paginate) => {
    ...
    if (!paginate) {
      ...
      shot = firebase
        ...
        .collection("communities")
        .orderBy("members", "desc")
        .startAfter(this.state.undoCommunity)
        .limit(10);
        ...
        (querySnapshot) => {
          ...
          querySnapshot.docs.forEach((doc) => {
            ...
            if (doc.exists) {
              ...
              /*if (community.communityType==="town/county") {
                  firebase
                    .firestore()
                    .collection("communities")
                    .doc(community.id)
                    .update({ communityType: "country/providence/state" });
                }*/
              if (
                this.props.auth !== undefined &&
                community.messageAsArray !== messageAsArray
              ) {
                firebase
                  .firestore()
                  .collection("communities")
          ...
          if (
            ...
            this.state.browsedCommunities !== browsedCommunities
          ) {
            const undoCommunity =
            ...
            this.setState({
              browsedCommunities,
              undoCommunity: undoCommunity
                ? undoCommunity
                : this.state.undoCommunity,
              lastCommunity: lastCommunity
                ? lastCommunity
                : this.state.lastCommunity
            });
          }
        },
  ...
  render() {
    ...
    const triggerNew = this.props.subForum
    ...
    return (
      ...
      >
        ...
        <Napkin
          ...
          browsedCommunities={browsedCommunities}
          lastCommunity={lastCommunity}
          undoCommunity={undoCommunity}
