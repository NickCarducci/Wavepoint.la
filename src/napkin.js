...
import Find from "./components/Forum/Find";
...
class Napkin extends React.Component {
  ...
  componentDidUpdate = (prevProps) => {
    ...
    if (this.state.focusSuggest !== this.state.lastFocusSuggest) {
      this.setState(
        { lastFocusSuggest: this.state.focusSuggest },
        () =>
  ...
  render() {
    ...
    var theLotOfPosts = this.props.globeChosen
      ...
      : commtype === "budget & proposal" && openWhen === "expired"
      ? this.props.oldBudget
      : commtype === "election" && openWhen === "expired"
      ? this.props.oldElections
      : commtype === "court case" && openWhen === "expired"
      ? this.props.oldCases
      : forumPosts;
    ...
    return (
      ...
      >
        ...
        <Find
          ...
          searching={searching}
          browsedCommunities={this.props.browsedCommunities}
          lastCommunity={this.props.lastCommunity}
          undoCommunity={this.props.undoCommunity}
          browseCommunities={this.props.browseCommunities}
        ...
        <Header
          ...
          y={this.props.y}
          distance={this.props.distance}
          started={this.props.started || this.props.drop}
          top={top}
          vertical={vertical}
