...
class Comments extends React.Component {
  ...
  render() {
    ...
    if (this.props.post && this.props.commtype === "court case") {
            ...
            >
              {
                ...
                firstPostPerPerson.map((x) => {
                  ...
                  var isProsecution =
                    x.community && x.community.prosecution.includes(x.authorId);
                  var isDefense =
                    x.community && x.community.defense.includes(x.authorId);
                  var isTestimoner =
                    x.community && x.community.testimonies.includes(x.authorId);
                  var isConsult =
