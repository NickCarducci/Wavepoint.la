...
class PeanutGallery extends React.Component {
  ...
  render() {
    const { vertical, postHeight, comments, auth, height } = this.props;
    var mine = [];
                    ...
                    onClick={() => {
                      if (auth !== undefined) {
                        if (this.state.comment !== "") {
                          ...
                          firebase
                            .firestore()
                            .collection(this.props.commentType)
                            .add({
                              messageAsArray,
                              parentAuthorId: this.props.chosenPost.authorId,
                              forumpostId: this.props.chosenPostId,
