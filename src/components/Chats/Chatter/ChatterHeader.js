              ...
              style={
                this.props.openWhat !== "topics"
                  ...
                  : {
                      ...
                      alignItems: "center",
                      width: "81px",
                      boxShadow: `inset -5px -10px 10px 1px rgb(20,20,20)`,
                      height: "30px",
                      fontSize: "15px",
            ...
            style={
              this.props.openWhat === "docs"
                ? {
                    ...
                    display: "flex",
                    fontSize: "15px",
                    backgroundColor: "rgba(32, 108, 255, 0.721)",
                    alignItems: "center",
                    justifyContent: "center",
                    height: "58px",
                    width: "81px",
                    color: "rgb(220,220,220)",
                    transition: ".3s ease-in",
                    boxShadow: "inset -5px 0px 5px 1px rgb(20,20,20)"
                  }
                : {
                    display: "flex",
                    fontSize: "15px",
                    ...
                    color: "grey",
                    transition: ".3s ease-out",
                    boxShadow: "inset -2px 0px 5px 5px rgb(0,0,0)"
                  }
            }
            role="img"
