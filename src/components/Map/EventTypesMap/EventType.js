    ...
    return (
      <div /*style={{ display: !subForum ? "block" : "none" }}*/>
        ...
        >
          ...
          >
            Service
            <HairNailsTanImg servtype={servtype} />
            <CateringImg servtype={servtype} />
            <LawyerImg servtype={servtype} />
            <MechanicImg servtype={servtype} />
          </div>
          <div
            onClick={(e) => {
              if (e.target.id) {
          ...
          >
            ...
            <InternistImg servtype={servtype} />
            <OrthopedistImg servtype={servtype} />
            <OrthodontistImg servtype={servtype} />
            <DentistImg servtype={servtype} />
          </div>
          ...
          >
            Digital
            <GraphicsAnimationImg servtype={servtype} />
            <PhotographyImg servtype={servtype} />
            <VideoProductionImg servtype={servtype} />
            <CodeImg servtype={servtype} />
          </div>
          <div
            onClick={(e) => {
              if (e.target.id) {
          ...
          >
            Planning
            <ArchitectureImg servtype={servtype} />
            <InteriorDesignImg servtype={servtype} />
            <LandscapingImg servtype={servtype} />
            <FramingImg servtype={servtype} />
          </div>
          <div
            onClick={(e) => {
              if (e.target.id) {
          ...
          >
            Solutions
            <HVACImg servtype={servtype} />
            <PaintingImg servtype={servtype} />
            <PlumbingImg servtype={servtype} />
            <ElectricianImg servtype={servtype} />
          </div>
          <div
            style={{
              maxWidth: `calc(${this.props.width - 4}px)`,
          ...
          >
            Project
            <AccountingImg servtype={servtype} />
            <CarpentryImg servtype={servtype} />
            <WeldingImg servtype={servtype} />
            <MasonryImg servtype={servtype} />
          </div>
          <div
            onClick={(e) => {
              if (e.target.id) {
          ...
          >
            Talents
            <MusicianImg servtype={servtype} />
            <ActorImg servtype={servtype} />
            <WriterImg servtype={servtype} />
            <SingerImg servtype={servtype} />
          </div>
        </div>
        <div
          className="eventtypessetmap"
