        ...
        >
          ...
          >
            ...
            {this.props.bills !== [] && this.props.commtype === "bills"
              ...
              : this.props.forumPosts[0] &&
                new Date(
                  this.props.forumPosts[0].time.seconds * 1000
                ).toLocaleDateString()}
            &nbsp;-
            <br />
            {this.props.bills !== [] && this.props.commtype === "bills"
              ...
              : this.props.forumPosts[0] &&
                this.props.forumPosts[this.props.forumPosts.length - 1]
              ? new Date(
                  this.props.forumPosts[this.props.forumPosts.length - 1].time
                    .seconds * 1000
                ).toLocaleDateString()
