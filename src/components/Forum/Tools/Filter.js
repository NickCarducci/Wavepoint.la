    ...
    if (type && (!community || isOpen || isMember || isAdmin)) {
      return (
        ...
        >
            ...
            if (opened) {
              return (
                ...
                >
                  ...
                  {isAdmin &&
                    ["election", "classes", "department"].includes(
                      this.props.commtype
                    ) && (
                      <div
                        onClick={() => {
          ...
          {["classes", "budget & proposal", "election", "court case"].includes(
            commtype
          ) && (
            <div
              style={{
          ...
          {["new", "lesson", "show", "game", "department"].includes(
            commtype
          ) && (
            <div
              style={{
            ...
            >
              ...
              {["department"].includes(commtype) ? `${commtype}s` : ""}
